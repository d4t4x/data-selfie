...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {chrome.browserAction.getBadgeText({}, function(text){
	    if(text.length > 0) {
	        $("#update").show();
